...
<body>
<input hidden id="types" value="${dormitoryAdminLists}">
        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="buildingServlet?method=search" method="post">
            ...
            <div class="table-responsive">
                ...
                <!-- add框示例（Modal） -->
                <form method="post" action="buildingServlet?method=save" class="form-horizontal" style="margin-top: 0px" role="form"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="adminId">
                                                    <c:forEach items="${dormitoryAdminLists}" var="dormitoryAdmin">
                ...
                <!-- update框示例（Modal） -->
                <form method="post" action="buildingServlet?method=update" class="form-horizontal" style="margin-top: 0px" role="form"
                      id="form_data" style="margin: 20px;">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control" name="adminId">
                                                    <c:forEach items="${dormitoryAdminLists}" var="admin">
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="buildingServlet?method=delete"
...
<script>
    // var typess=document.querySelector("#types");
    // console.log(typess)
    // console.log(typess.value)
